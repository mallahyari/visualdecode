...
defineMacro("\\message", function (context) {
  ...
  /* eslint-disable */console.log(...oo_oo(`6c90d85f_0`,arg.reverse().map(function (token) {
    return token.text;
  }).join("")));
  return '';
});
...
defineMacro("\\show", function (context) {
  ...
  /* eslint-disable */console.log(...oo_oo(`6c90d85f_1`,tok, context.macros.get(name), src_functions[name], src_symbols.math[name], src_symbols.text[name]));
  return '';
}); //////////////////////////////////////////////////////////////////////
// Grouping
