...
defineMacro("\\message", context => {
  ...
  /* eslint-disable */console.log(...oo_oo(`28769368_0`,arg.reverse().map(token => token.text).join("")));
  return '';
});
...
defineMacro("\\show", context => {
  ...
  /* eslint-disable */console.log(...oo_oo(`28769368_1`,tok, context.macros.get(name), functions[name], symbols.math[name], symbols.text[name]));
  return '';
}); //////////////////////////////////////////////////////////////////////
// Grouping
